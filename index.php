...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Covid-TMS</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">Covid Symptoms</a>
          </li>
          <li class="nav-item">
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1>COVID-TMS</h1>
      <p class="lead">COVID Testing Management System</p>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="lead">Coronavirus disease  is an infectious disease caused by a newly discovered coronavirus. Most people infected with the COVID-19, virus will experience mild to moderate, respiratory illness & recover without requiring special treatment. Older people and those with underlying medical problem like cardiovascular disease.</p>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Yuvraj 2022</p>
    </div>
    <!-- /.container -->
  </footer>
